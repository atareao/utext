...
class SearchDialog(Gtk.Dialog):
	def __init__(self,searched_text=''):
		#
		Gtk.Dialog.__init__(self, 'uText | '+_('Search'),None,Gtk.DialogFlags.MODAL | Gtk.DialogFlags.DESTROY_WITH_PARENT,(Gtk.STOCK_CANCEL, Gtk.ResponseType.REJECT,Gtk.STOCK_OK, Gtk.ResponseType.ACCEPT))
