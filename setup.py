...
DATA_FILES = [
	('/opt/extras.ubuntu.com/utext/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/utext/share/utext',['debian/changelog']),
	('/opt/extras.ubuntu.com/utext/share/utext',glob.glob('src/*.py')),
	('/opt/extras.ubuntu.com/utext/share/utext/themes',['src/themes/gtk.css','src/themes/gtk_night_mode.css','src/themes/header.html']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/bartic',['src/themes/bartic/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/bootstrap',['src/themes/bootstrap/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/default',['src/themes/default/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/github',['src/themes/github/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/jasonm23-dark',['src/themes/jasonm23-dark/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/jasonm23-foghorn',['src/themes/jasonm23-foghorn/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/jasonm23-markdown',['src/themes/jasonm23-markdown/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/jasonm23-swiss',['src/themes/jasonm23-swiss/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/markedapp-byword',['src/themes/markedapp-byword/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-book',['src/themes/mixu-book/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-bootstrap',['src/themes/mixu-bootstrap/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-bootstrap-2col',['src/themes/mixu-bootstrap-2col/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-gray',['src/themes/mixu-gray/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-page',['src/themes/mixu-page/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/mixu-radar',['src/themes/mixu-radar/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/normalice',['src/themes/normalice/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/preview-dark',['src/themes/preview-dark/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/roryg-ghostwriter',['src/themes/roryg-ghostwriter/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/thomasf-solarizedcssdark',['src/themes/thomasf-solarizedcssdark/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/thomasf-solarizedcsslight',['src/themes/thomasf-solarizedcsslight/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/themes/witex',['src/themes/witex/style.css']),
	('/opt/extras.ubuntu.com/utext/share/utext/icons',glob.glob('data/icons/*.svg')),
	...
	('/opt/extras.ubuntu.com/utext/share/utext/pypandoc',glob.glob('src/pypandoc/*.py')),
...
def update_desktop_file_fp():
	...
	for filedesktopin in glob.glob('*.desktop.in'):
		...
		print(desktopfile.sections())
		if len(lns)>0:
			for asection in desktopfile.sections():
				for entry in desktopfile.items(asection):
					if entry[0].startswith('_'):
						for ln in lns:
							desktopfile.set(asection,'$%s[%s]'%(entry[0][1:],ln),"_('%s')"%entry[1])
...
def update_desktop_file():
	...
	for filedesktopin in glob.glob('*.desktop.in'):
		...
		if len(lns)>0:
			for nsection,asection in enumerate(desktopfile.sections()):
				if nsection>0:
					fileout.write('\n')
				fileout.write('['+asection+']\n')
				for entry in desktopfile.items(asection):
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/utext/share', 'locale-langpack', lang, 'LC_MESSAGES')
